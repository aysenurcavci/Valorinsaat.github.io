...
<body>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid main-header py-5 mb-5" style="height: 600px;">
    ...
    <div class="container-xxl py-0">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInDown" data-wow-delay="0.1s" style="max-width: 600px;">
                <h2 class="mb-4" style="color: #FCA311;">Faaliyetlerimiz</h2>
            </div>
            <div class="row g-4">
                <div class="col-md-4 col-lg-4 wow fadeInUp hcolor text-center" data-wow-delay="0.1s">
                    <div class="service-item rounded overflow-hidden">
                        <a href="faaliyetler">
                            <img class="img-fluid card-img" src="img/yapi_isleri.png" alt="Yapı İşleri">
                        </a>
                        <div class="position-relative p-4 pt-4 ">
                            <p class="mb-3 text-center" style="font-size:2.5ch; font-family:Merriweather Sans">Yapı
                                İşleri</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 wow fadeInUp text-center hcolor" data-wow-delay="0.3s">
                    <div class="service-item rounded overflow-hidden">
                        <a href="faaliyetler">
                            <img class="img-fluid card-img" src="img/mekanik_isler.avif" alt="Mekanik İşler">
                        </a>
                        <div class="position-relative p-4 pt-4">
                            <p class="mb-3 text-center" style="font-size:2.5ch; font-family:Merriweather Sans">Mekanik
                                İşler</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 wow fadeInUp hcolor text-center" data-wow-delay="0.5s">
                    <div class="service-item rounded overflow-hidden">
                        <a href="faaliyetler">
                            <img class="img-fluid card-img" src="img/elektrik_isleri.avif" alt="Elektirik İşleri">
                        </a>
                        <div class="position-relative p-4 pt-4 ">
                            <p class="mb-3  text-center" style="font-size:2.5ch; font-family:Merriweather Sans">Elektrik
                                İşleri</p>
                        </div>
                    </div>
                </div>
